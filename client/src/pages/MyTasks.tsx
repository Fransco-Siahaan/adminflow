                    ...
                    {TABS.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 py-2.5 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${isActive
                            ...
                            >
                                {tab.label}
                                <span
                                    className={`ml-2 px-1.5 py-0.5 rounded-full text-xs ${isActive
